...
public class ComPanPri extends javax.swing.JFrame
{
    ...
    private void initComponents() {
        ...
        mnuMaeCom.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mnuMaeComActionPerformed(evt);
            }
        });
    ...
    private void mnuArcSalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuArcSalActionPerformed
        ...
        //if (JOptionPane.showConfirmDialog(this, "¿Está seguro que desea salir?", "ComputadorasTES", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE)==JOptionPane.YES_OPTION)
    ...
    private void mnuArcLogIngSisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuArcLogIngSisActionPerformed
        archivo.ComArcLogIngSis objArcLogIngSis=new archivo.ComArcLogIngSis();
