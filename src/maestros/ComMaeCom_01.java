 ...
 * @author prof_tes_a
 */
public class ComMaeCom_01 extends javax.swing.JDialog
{
    private boolean blnAce;
    private Vector<String> vecMar, vecImgMar;
    
    /**
     * Creates new form ComMaeCom_01
     */
    public ComMaeCom_01(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        lstMar.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lstMarMouseClicked(evt);
            }
        });
        lstMar.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                lstMarKeyPressed(evt);
            }
        });
    ...
    private void lstMarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_lstMarKeyPressed
        if (evt.getKeyCode()==java.awt.event.KeyEvent.VK_ENTER)
            butAceActionPerformed(null);
    }//GEN-LAST:event_lstMarKeyPressed

    private void lstMarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lstMarMouseClicked
        if (evt.getClickCount()==2)
            butAceActionPerformed(null);
    }//GEN-LAST:event_lstMarMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ComMaeCom_01.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ComMaeCom_01 dialog = new ComMaeCom_01(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JList<String> lstMar;
    ...
    private boolean cargarMarcas()
    {
        ...
        try
        {
            java.io.FileReader objFilRea=new java.io.FileReader("ComMarcas.txt");
    ...
    private boolean cargarImagenesMarcas()
    {
        ...
        try
        {
            java.io.FileReader objFilRea=new java.io.FileReader("ComImagenesMarcas.txt");
            java.io.BufferedReader objBufRea=new java.io.BufferedReader(objFilRea);
            String strLin;
